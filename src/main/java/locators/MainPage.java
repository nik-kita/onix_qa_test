...
public enum MainPage implements Locator {
    ...
    public static By openMenuLink(MenuLink menuLink) {
        return menuLink.getPath();
    }
}

enum MenuLink implements Locator {
    ...
    JAVASCRIPT_ALERTS(By.cssSelector("[href='/script_alerts']")),
